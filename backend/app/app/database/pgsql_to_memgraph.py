...
if input_people:
    ...
    print("skipping person node entry")
...
if input_org_memberships:
    print("entering organization parent/child relationships")
    ...
    for o in progressbar.progressbar(orgs_with_parents):
        try:
            ...
            om = MGMembership(
                _start_node_id=child._id, _end_node_id=parent._id, source=child.source
            ).save(db=db)
        except Exception as e:
            print(o)
            print(e)

    print("organization parent/child orgs entered")
else:
    print("skipping org/org memberships")

if input_person_memberships:
    print("entering person/org memberships")
    ...
    for mem in progressbar.progressbar(person_memberships):
        try:
            ...
            print(mem)
            print(e)
    print("person/org memberships entered")
else:
    print("skipping person/org memberships")

if input_person_person_comms:
    print("entering person/person communications")
    ...
    print("person/person communications entered")
else:
    print("skipping person/person communications")

if input_person_org_comms:
    print("entering person/org communications")
    ...
    print("person org communications entered")
else:
    print("skipping person/org communications")

if input_org_org_comms:
    print("entering org/org communications")
    ...
    print("org/org communications entered")
else:
    print("skipping org/org communications")

if input_person_person_funding:
    print("entering person/person funding")
    ...
    print("person to person fundings entered")
else:
    print("skipping person/person funding")

if input_person_org_funding:
    print("entering person/org funding")
    ...
    for f in progressbar.progressbar(person_person_funding):
        try:
            ...
            print(f)
            print(e)
    print("person/org funding entered")
else:
    print("skipping person/org funding")

if input_org_org_funding:
    print("entering org/org funding")
    sq = select(Funding)
    person_person_funding = sess.exec(sq)
    for f in progressbar.progressbar(person_person_funding):
        try:
            ...
            print(f)
            print(e)
    print("org/org funding entered")
else:
    print("skipping org/org funding")
