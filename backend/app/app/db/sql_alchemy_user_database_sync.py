...
class SQLAlchemyUserDatabaseSync(Generic[UP, ID], BaseUserDatabase[UP, ID]):
    """
    ...
    def create(self, create_dict: Dict[str, Any]) -> UP:
    ...
    def update(self, user: UP, update_dict: Dict[str, Any]) -> UP:
