export const TermsLicense = () => {
  ...
  <div>
    ...
    These Terms of Use form a legally binding contract between LOBBYRADAR (the “Authors”, “we” or “us”)
    and the people and companies (“Users” or “you”) that access and use
    our website located at www.lobbyradar.io or any related website or mobile
    platform controlled by us (collectively, the "Website"). These Terms of Use apply to all
    services provided through our Website and any other software application we operate, and
    all content, services, and products available at or through the Website.</p><p>
    ...
    into a legally binding contract which will impact your rights.</p><p>
    ...
    or use any services available on the Website.</p><p>

    These Terms of Use should be read in conjunction with the Privacy Policy and any other
    rules, guidelines, or policies posted on the Website.</p>

    <h3>2. SERVICES AVAILABLE ON THE WEBSITE</h3><p>

    Without restriction, we generally offer the following services through the Website:</p>
    ...
    <h3>3. TERMINATION</h3><p>

    You may cancel these Terms of Use at any time by discontinuing your use of the Website.</p>

    <h3>4. LIMITATION OF LIABILITY</h3><p>
    ...
    damages of any kind resulting in any way from use of the Website.</p><p>
    ...
    not warrant that your use of the Website will be uninterrupted, secure or error-free.</p><p>
    ...
    such part thereof, shall be inapplicable.</p>

    <h3>5. INDEMNIFICATION</h3><p>

    You agree to indemnify and hold harmless LOBBYRADAR, including
    ...
    term of these Terms of Use or any other policy posted on the Website.</p>

    <h3>6. SECURITY BREACHES</h3><p>

    In order to protect your security, it is your sole responsibility to ensure that all usernames
    and passwords used to access the Website are kept secure and confidential.</p><p>

    You must immediately notify us of any unauthorized use of your account, including the
    unauthorized use of your password, or any other breach of security.</p><p>
    ...
    <h3>7. WARRANTIES AND REPRESENTATIONS</h3><p>
    ...
    particular purpose as they relate to the Website.</p>

    <h3>8. COMPLIANCE WITH LAWS</h3><p>

    You represent and warrant that:</p><p>

    i. You have the authority to bind yourself to these Terms of Use;</p><p>
    ...
    intellectual property rights of any User or third party; and</p><p>

    iv. Your use of the Website will comply with all local, provincial and federal laws, rules
    and regulations, and with all policies posted on the Website.</p><p>
    ...
    services are provided comply with and accept all these Terms of Use.</p>

    <h3>9. AGE RESTRICTIONS</h3><p>

    Users under the age of 18 are only permitted to access and use the Website while under
    the direct supervision of a parent or guardian.</p>

    <h3>10. GOVERNING LAW AND DISPUTE RESOLUTION</h3><p>

    These Terms of Use and any access to or use of the Website shall be governed by, and
    construed in accordance with, the laws in force in the Province of Alberta.</p><p>

    If any claim, dispute or controversy occurs between LOBBYRADAR
    and a User relating to the interpretation or implementation of any of the provisions of
    these Terms of Use, such dispute shall be resolved by private, confidential and binding
    ...
    LOBBYRADAR Arbitration shall be held in the Province of Alberta,
    ...
    entered in any court having jurisdiction.</p>

    <h3>11. WAIVER OF CLASS ACTION</h3><p>
    ...
    action lawsuit commenced against LOBBYRADAR or its affiliates
    related to any claim, dispute or controversy arising from your use of the Website. Where
    applicable, you hereby agree to opt out of any class proceeding against LOBBYRADAR otherwise commenced.</p><p>
    ...
    unenforceable at law.</p>

    <h3>12. GENERAL TERMS</h3>

    <h4>a. AMENDING THESE TERMS OF USE</h4><p>
    ...
    not we deemed the amendments to be material.</p>

    <h4>b. ASSIGNMENT</h4><p>
    ...
    agents. LOBBYRADAR has no fiduciary obligations or
    professional obligations whatsoever to you arising from these Terms of Use or your
    use of the Website.</p>

    <h4>e. SEVERABILITY</h4><p>
    ...
    constitute the entire agreement between you and LOBBYRADAR
    and supersede all prior communications, agreements and understandings, written or
    oral, with respect to the subject matter of these Terms of Use.</p>
    ...
    POLICIES AND NOTICES POSTED ON THE WEBSITE.</p>
