...
export const PrivacyLicense = () => {
  ...
  <div>
    ...
    <p><b>LAST UPDATED: 2023-02-24</b></p>
 
    <h3>1. OVERVIEW</h3>

    <p>
    At LOBBYRADAR (the “Authors”, “we” or “us”), we use our website
    and other internet-based tools for the following purpose:</p>

    <p><b>We provide tools and interfaces to improve access and understanding of connected open source Government of Canada data.</b></p><p>
    ...
    on all communications between the Authors and Users, including but not limited to
    communication via:</p><p>

    1. the Authors website (including the website hosted at www.lobbyradar.io
    and any other web domain used by the Authors to communicate with users now or
    in the future);</p><p>

    2. any mobile, computer, or tablet-based application currently offered by Authors or
    developed in the future by the Authors; and</p><p>
    
    3. all other services provided by the Authors, as described on the Website (Items 1, 2 and 3
    are collectively referred to as the "Website").</p><p>
    ...
    experience of using the Website.</p><p>
    ...
    result in you not being able to use the Website, either in its entirety or certain features. </p><p>

    Using cookies, you may have the option to allow us to save your user ID and login
    password for future logins to the Website.</p><p>
    ...
    present you with advertisements about the Authors after you visit the Website. We will
    provide third-party providers of remarketing services with the minimum amount of
    information required to facilitate remarketing, and in no circumstances will Authors
    provide any personal identifying information to third-parties for the purpose of
    remarketing.</p><p>

    <h3>5. PERMITTED USES OF DATA</h3></p><p>
    ...
    personal identifying information.</p><p>

    We may use the data collected from the Website, devices, browsers, and any other sources,
    for its own purposes, both related to and unrelated to improving the Website.</p><p>


    <h3>6. LEGAL BASIS FOR PROCESSING PERSONAL IDENTIFYING INFORMATION</h3></p><p>

    We may process your personal identifying information for a number of reasons, including:</p>
    ...
    accordance with the Policy.</p><p>

    You may decline to share certain personal information with us, in which case you may not
    be able to use the Website, either in its entirety or certain features.</p><p>

    When deleting your information, whether by request or due to inactivity, we will use
    standard electronic means to remove your personal information from our files.</p><p>

    We will also retain any and all information that we are required to retain under any
    applicable laws for the full duration of time required under those laws.</p><p>

    <h3>8. KEEPING YOUR DATA SECURE</h3></p><p>
    ...
    information in any physical or paper-based format.</p><p>
    ...
    intended to prevent unauthorized access or improper use.</p><p>
    ...
    complete protection and security of your personal information.</p><p>
    ...
    before proceeding to use the Website.</p><p>
    
    <h3>9. SECURITY BREACHES</h3></p><p>
    ...
    advise all known affected Users within 14 days of learning of the breach.</p><p>
    
    <h3>10. THIRD-PARTY APPLICATIONS</h3></p><p>
    ...
    their privacy policies. </p><p>

    Without limitation, the Authors use or may use the following third-party applications
    and services in conjunction with the Website:</p>
    ...
    information you may provide directly to these applications.</p><p>


    <h3>11. USE OF WEBSITE BY MINORS</h3></p><p>

    The Website is not intended to be accessed by persons under the age of 18. The Authors
    do not engage in any marketing efforts aimed at children or minors.</p><p>

    Persons under the age of 18 are prohibited from using the Website without the express
    permission and direct supervision of a parent or guardian. Minors are prohibited from
    submitting any personal identifying information through the Website. The Authors will
    immediately delete any personal identifying information submitted in violation of this
    Policy.</p><p>


    <h3>12. DISCLOSURE OF PERSONAL INFORMATION</h3></p><p>
    ...
    We may disclose your personal information to third parties:</p><p>

    1. In the event that we sell or buy any business or assets, in which case we may disclose
    your personal data to the prospective seller or buyer of such business or assets.</p><p>
    
    2. If the Authors or its assets are acquired by a third party, in which case personal data 
    about Users may be one of the transferred assets.</p><p>
    ...
    the rights, property, or safety of the Authors, our Users, or others. This includes
    exchanging information with other companies and organizations for the purposes of
    fraud protection and credit risk reduction.</p><p>

    <h3>13. AMENDING THIS POLICY</h3></p><p>
    ...
    use of the Website will be deemed acceptance of any amended Policy.</p><p>
