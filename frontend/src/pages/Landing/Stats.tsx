    ...
    <div className='bg-secondary'>
      <div className='mx-auto max-w-7xl py-12 px-6 sm:py-16 lg:px-8 lg:py-20'>
        <div className='mx-auto max-w-4xl text-center'>
          ...
          <p className='mt-3 text-xl text-secondary-text sm:mt-4'>
            <StatsPunchline />
          </p>
        </div>
        <dl className='mt-10 text-center sm:mx-auto sm:grid sm:max-w-3xl sm:grid-cols-3 sm:gap-8'>
          <div className='flex flex-col'>
            <dt className='order-2 mt-2 text-lg font-medium leading-6 text-secondary-text'>
            <Stat1Label />
            </dt>
            <dd className='order-1 text-5xl font-bold tracking-tight dark:text-primary-d text-primary-d'>
            <Stat1Value />
            </dd>
          </div>
