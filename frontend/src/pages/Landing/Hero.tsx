  ...
  return (
    <div>
      <div className='mx-auto mt-[-96px] flex h-screen w-full max-w-[800px] flex-col justify-center text-center'>
        <p className='p-2 font-bold text-primary dark:text-primary-d'>
        ...
        <Link to='/register'>
          <button className='my-6 mx-auto w-[200px] rounded-md bg-primary dark:bg-primary-d py-3 font-medium text-morp'>
            Get Started
          </button>
        </Link>
      </div>
